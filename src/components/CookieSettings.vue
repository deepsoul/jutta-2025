    ...
    <v-card>
      ...
      <v-card-text class="pa-6 pt-0">
        <p class="text-jutta-700 mb-6">
          Verwalten Sie Ihre Cookie-Einstellungen. Sie können Ihre Auswahl
          jederzeit ändern.
        </p>
        ...
        <div class="space-y-6">
          ...
          <div class="d-flex align-start justify-space-between">
            <div class="flex-grow-1 mr-4">
              <h4
                class="text-subtitle-1 font-weight-medium text-jutta-900 mb-2"
              >
                Notwendige Cookies
              </h4>
          ...
          <div class="d-flex align-start justify-space-between">
            <div class="flex-grow-1 mr-4">
              ...
              <p class="text-body-2 text-jutta-600 mb-0">
                Werden verwendet, um Besuchern relevante Anzeigen und Inhalte zu
                zeigen.
              </p>
            </div>
            <v-switch
      ...
      <v-card-actions class="pa-6 pt-0">
        ...
        <v-btn color="jutta-900" @click="saveSettings" class="text-white">
